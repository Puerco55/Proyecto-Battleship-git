...
public class AjustesPartida extends JFrame {
    ...
    public AjustesPartida(String equipoJugador1, String equipoJugador2) {
        ...
        for (int i = 0; i < nombresBarcos.length; i++) {
            gbc.gridx = 0; gbc.gridy = i + 1; gbc.weightx = 0.6;
            ...
            if (i == 0)      spinners[i] = new JSpinner(new SpinnerNumberModel(1, 0, 1, 1)); // Barco 5: Max 1
            else if (i == 1) spinners[i] = new JSpinner(new SpinnerNumberModel(1, 0, 1, 1)); // Barco 4: Max 1
            else if (i == 2) spinners[i] = new JSpinner(new SpinnerNumberModel(2, 0, 2, 1)); // Barco 3: Max 2
        ...
        gbc.gridx = 0; gbc.gridy = nombresBarcos.length + 1; gbc.gridwidth = 2;
        ...
        guardarButton.addActionListener(e -> {
            ...
            if (configBarcos.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Selecciona al menos un barco.", "Error", JOptionPane.WARNING_MESSAGE);
                return;
            }
            if (totalCasillas > 50) {
                JOptionPane.showMessageDialog(this, "Demasiados barcos. Máximo 50 casillas ocupadas.", "Error", JOptionPane.WARNING_MESSAGE);
                return;
            }
